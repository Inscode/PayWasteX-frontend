    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-8xl pl-9  mx-auto flex flex-col md:flex-row min-h-[90vh]">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 md:px-12 py-8 md:py-16 text-white relative">
          ...
          <div className="relative z-10">
            ...
            <p className="mb-4 text-lg font-semibold text-green-100 drop-shadow-lg">
              Easily track your waste fee bills, payment history, and outstanding dues all in one secure place.
              {/* <br /> */}
              <span className="text-white">Log in to manage your records, view invoices, and stay updated with council notifications.</span>
            </p>
            <br />
            {/* Multilingual Subs */}
            <p className="mb-2 text-xs md:text-base text-white drop-shadow-lg">
              ඔබේ අපද්‍රව්‍ය ගාස්තු බිල්පත්, ගෙවීම් ඉතිහාසය සහ නියමිත ගෙවීම් සියල්ල එකිනෙකා ආරක්ෂිත ස්ථානයක කළමනාකරණය කරන්න.
              ඔබගේ වාර්තා කළමනාකරණය කිරීමට, ඉන්වොයිස් බැලීමට සහ පවුල් නිලධාරීන්ගෙන් නිවේදන ලබා ගැනීමට මෙහි පිවිසෙන්න.
            </p>
            <br />
            <p className="text-xs md:text-base text-white drop-shadow-lg">
              உங்கள் கழிவு கட்டண பில்கள், கட்டண வரலாறு மற்றும் நிலுவைத் தொகைகளை அனைத்தையும் ஒரு பாதுகாப்பான இடத்தில் எளிதாகக் கண்காணியுங்கள்.
              உங்கள் பதிவுகளை நிர்வகிக்க, இன்வாய்ஸ்களைப் பார்க்க மற்றும் கவுன்சிலில் அறிவிப்புகளுடன் புதுப்பித்த நிலையில் இருக்க உள்நுழையவும்.
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center min-h-[700px] px-1 py-1 md:p-10">
          ...
          >
            <h3 className="text-2xl font-bold text-white text-center mb-4">SIGN IN</h3>
            <label className="block text-white font-semibold mb-1">
              <span className="text-red-400">*</span> Username / බරව්ය නාමය / பயனர்பெயர்
              <input
                type="text"
                required
                value={username}
            ...
            <label className="block text-white font-semibold mb-1">
              <span className="text-red-400">*</span> Password / මුරපදය / கடவுச்சொல்
              <input
                type="password"
                required
                value={password}
