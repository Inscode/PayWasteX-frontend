...
const ResponsibleOfficerSettings = () => {
  ...
  useEffect(() => {
    const fetchZones = async () => {
      ...
      try {
        ...
        const transformedZones = data.map((zone, index) => ({
          id: index + 1,
          code: zone.zoneCode,
          name: zone.zoneName,
          description: zone.description,
          status: zone.active === "true" ? "active" : "inactive",
          businesses: 0,
        }));
  ...
  const [customers, setCustomers] = useState([
    {
      id: 1,
      regNo: "REG001",
      companyName: "Railway Tourist Bungalow",
      ownerName: "M S D Priyantha",
      zone: "A1",
      phone: "+94771234567",
      email: "priyantha@rtb.lk",
      status: "active",
    },
    {
      id: 2,
      regNo: "REG002",
      companyName: "Sunset Hotel",
      ownerName: "Nirosha Perera",
      zone: "A2",
      phone: "+94772345678",
      email: "nirosha@sunset.lk",
      status: "active",
    },
    {
      id: 3,
      regNo: "REG003",
      companyName: "Ocean View Café",
      ownerName: "Tharindu Silva",
      zone: "B1",
      phone: "+94773456789",
      email: "tharindu@oceanview.lk",
      status: "active",
    },
    {
      id: 4,
      regNo: "REG004",
      companyName: "Green Leaf Spa",
      ownerName: "Harsha Bandara",
      zone: "A1",
      phone: "+94774567890",
      email: "harsha@greenleaf.lk",
      status: "inactive",
    },
  ]);
  ...
  const [collectors, setCollectors] = useState([
    {
      ...
      zones: ["A1", "A2"],
      phone: "+94711234567",
      email: "prasad.p@municipality.lk",
      status: "active",
      collections: 156,
    },
    {
    ...
    },
    {
      ...
      zones: ["A3"],
      phone: "+94714567890",
      email: "kamala.b@municipality.lk",
      status: "inactive",
      collections: 45,
    },
  ]);
  ...
  const handleSave = async () => {
    ...
    if (activeTab === "zones") {
      ...
      if (editingItem) {
        setCustomers(
          customers.map((c) => (c.id === editingItem.id ? newItem : c))
        );
      } else {
      ...
      if (editingItem) {
        setCollectors(
          collectors.map((c) => (c.id === editingItem.id ? newItem : c))
        );
      } else {
        setCollectors([
          ...collectors,
          { ...newItem, collections: 0, status: "active" },
        ]);
      }
    }
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800">
                  Responsible Officer Settings
                </h1>
                <p className="text-gray-600">
                  Manage zones, customers, and fee collectors
                </p>
              </div>
            </div>
            <button
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (e.target.checked) {
                          ...
                          updateFormData(
                            "zones",
                            currentZones.filter((z) => z !== zone.code)
                          );
                        }
                      }}
