    ...
    <nav className="bg-green-700 flex items-center justify-between px-6 py-2 w-full min-h-[64px]">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm text-green-100 font-medium">Track. Pay. Stay Updated</span>
        </div>
      </div>

      <div className="flex items-center gap-8">
        <div className="flex gap-4 text-white text-lg font-semibold">
          <button onClick={() => switchLanguage("si")} className="hover:underline transition">සිංහල</button>
          <button onClick={() => switchLanguage("ta")} className="hover:underline transition">தமிழ்</button>
          <button onClick={() => switchLanguage("en")} className="hover:underline transition">EN</button>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 z-10 hidden group-hover:block bg-white text-black rounded shadow-md mt-2 min-w-[140px]">
            ...
            <button className="w-full px-4 py-2 text-left hover:bg-gray-100" onClick={logout}>
              Logout
            </button>
          </div>
        </div>
